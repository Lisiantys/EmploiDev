<template title="Politique de confidentialité">
    <div class="p-6 sm:p-10 md:pl-32">
        <div class="space-y-4">
            <h2 class="font-semibold text-lg md:text-2xl">Propriétaire du site : </h2>

            <p>Le site web Winter Bike est détenu par Maxime POUZARGUE, qui est un contrôleur de données de vos données
                personnelles.</p>
        ...
        <div class="space-y-4 mt-5">
            ...
            <p class="leading-9">
                Lorsque vous visitez le Winter Bike, nous recueillons automatiquement certaines informations sur votre
                ...
                recueillons des informations sur les pages web que vous consultez, sur les sites web ou les termes de
                recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous
                désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En
                outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans
                s'y limiter, le nom, le prénom, l'adresse, etc.) lors de la création d'événement ou de compte sur notre
                site.
            </p>
        </div>
        ...
        <div class="space-y-4 mt-5">
            ...
            <p class="leading-9">
                Notre priorité absolue est la sécurité des données des clients et, à ce titre, nous ne pouvons traiter
        ...
        <div class="space-y-4 mt-5">
            ...
            <p class="leading-9">
                ...
                environnement contrôlé et sécurisé, protégé contre tout accès, utilisation ou divulgation non autorisés.
                Nous conservons des garanties administratives, techniques et physiques raisonnables pour nous protéger
                contre tout accès, utilisation, modification et divulgation non autorisés des données personnelles sous
                son contrôle et sa garde. Toutefois, aucune transmission de données sur Internet ou sur un réseau sans
