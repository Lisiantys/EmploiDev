<template>
    <form @submit.prevent="applyFilters">
        <div
            class="hidden flex-col md:flex lg:flex-row mt-10 p-6 border-4 border-blue-400 rounded-lg shadow-md"
        >
            ...
            <div class="flex flex-col justify-between w-5/6">
                    ...
                    >
                        ...
                        >
                            ...
                            <label
                                ...
                                class="ml-2 block text-sm font-semibold text-gray-800"
                                >{{ contract.name }}</label
                            >
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <input
                                ...
                                type="checkbox"
                                class="form-checkbox h-4 w-4 text-blue-600"
                                v-model="selectedYearsExperiences"
                                :value="year.id"
                            />
                            <label
                                :for="`year-${year.id}`"
                                class="ml-2 block text-sm text-gray-800 font-semibold"
                                >{{ year.name }}</label
                            >
                        </div>
                    </div>
                ...
                <div class="w-96">
                    <label
                        for="localisation"
                        class="block text-sm font-bold text-black mb-2 lg:mb-0"
                        >Ville</label
                    >
                    <select
            ...
            <div class="flex flex-col justify-between w-full">
                <label
                    for="languages"
                    class="block text-sm font-bold text-black lg:ml-4 mb-4 pt-4 lg:pt-0"
                    >Langages de Programmations :</label
                >
                ...
                <!-- Section Type et Btn -->
                <div
                    class="flex justify-between lg:justify-end xl:justify-between mt-2 items-center"
                >
