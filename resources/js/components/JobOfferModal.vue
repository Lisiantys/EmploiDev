        ...
        <div class="bg-white rounded-lg shadow-lg max-w-4xl w-full mx-4 md:mx-0">
            ...
            <div v-if="jobOffer && jobOffer.name">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="md:w-2/3 md:pl-6 mt-4 md:mt-0">
                            ...
                            <p v-if="jobOffer.types_contract">
                                <strong>Type de Contrat :</strong> {{ jobOffer.types_contract.name }}
                            </p>
                            <p v-if="jobOffer.types_developer">
                                <strong>Type de Développeur Recherché :</strong> {{ jobOffer.types_developer.name }}
                            </p>
                            <p v-if="jobOffer.years_experience">
                                <strong>Années d'Expérience Requises :</strong> {{ jobOffer.years_experience.name }}
                            </p>
                            <p v-if="jobOffer.location">
                                <strong>Lieu :</strong> {{ jobOffer.location.city }}, {{ jobOffer.location.postal_code
                                }}
                            </p>
                            <p>
                            ...
                            <div class="mt-4"
                                v-if="jobOffer.programming_languages && jobOffer.programming_languages.length">
                    ...
                    <!-- Application Form visible only to authenticated developers -->
                    <div v-if="authStore.user && authStore.user.role_id === 1">
                        ...
                        <!-- Show application form if user hasn't applied yet -->
                        <div v-else>
                            ...
                            <form @submit.prevent="submitApplication">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" @change="handleFileUpload($event, 'cover_letter')"
                                        class="w-full border rounded px-3 py-2" />
