<template>
    <form @submit.prevent="handleStepSubmission">
        ...
        <div v-if="step === 1" class="tab">
            <div class="mb-5">
                ...
                <input v-model="company.name" id="name"
                    ...
                    placeholder="Nom de l'entreprise..." required minlength="2" maxlength="50"/>
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Description (optionnel)</label>
                <textarea v-model="company.description" id="description"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Une brève description de votre entreprise..." minlength="10" maxlength="255"></textarea>
            </div>
        </div>
        ...
        <div class="flex justify-between">
            ...
            <button type="submit" v-if="step < 2">Suivant</button>
            <button type="submit" v-if="step === 2">S'inscrire</button>
        </div>
    </form>
</template>
